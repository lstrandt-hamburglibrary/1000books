...
function startPatternBuilder(level = 1) {
    const patternsByLevel = {
        1: [ // Easy - Simple AB and AAB patterns
        ...
        2: [ // Medium - ABC, AAB, ABB, ABA patterns
            { pattern: ['🔴', '🔵', '🟢', '🔴', '🔵'], answer: '🟢', options: ['🔴', '🔵', '🟢', '🟡'] },
            ...
            { pattern: ['🍓', '🍇', '🍓', '🍓', '🍇'], answer: '🍓', options: ['🍓', '🍇', '🍒', '🍊'] },
            { pattern: ['⚽', '🏀', '⚾', '⚽', '🏀'], answer: '⚾', options: ['⚽', '🏀', '⚾', '🎾'] },
            { pattern: ['🌈', '☁️', '☁️', '🌈', '☁️'], answer: '☁️', options: ['🌈', '☁️', '⛅', '🌤️'] },
            { pattern: ['🎵', '🎶', '🎵', '🎵', '🎶'], answer: '🎵', options: ['🎵', '🎶', '🎼', '🎤'] },
            { pattern: ['🚗', '🚙', '🚕', '🚗', '🚙'], answer: '🚕', options: ['🚗', '🚙', '🚕', '🚌'] },
            { pattern: ['🌻', '🌷', '🌷', '🌻', '🌷'], answer: '🌷', options: ['🌻', '🌷', '🌹', '🌺'] },
            { pattern: ['🍪', '🧁', '🍩', '🍪', '🧁'], answer: '🍩', options: ['🍪', '🧁', '🍩', '🍰'] },
        ...
        3: [ // Hard - ABCD, AABB, ABBA, AAAB patterns
            { pattern: ['🔴', '🔵', '🟢', '🟡', '🔴', '🔵', '🟢'], answer: '🟡', options: ['🔴', '🔵', '🟢', '🟡'] },
            ...
            { pattern: ['🍓', '🍇', '🍒', '🍓', '🍇', '🍒'], answer: '🍓', options: ['🍓', '🍇', '🍒', '🍊'] },
            { pattern: ['⚽', '🏀', '⚾', '🎾', '⚽', '🏀', '⚾'], answer: '🎾', options: ['⚽', '🏀', '⚾', '🎾'] },
            { pattern: ['🌈', '☁️', '⛅', '🌈', '☁️', '⛅'], answer: '🌈', options: ['🌈', '☁️', '⛅', '🌤️'] },
            { pattern: ['🎵', '🎶', '🎶', '🎵', '🎵', '🎶', '🎶'], answer: '🎵', options: ['🎵', '🎶', '🎼', '🎤'] },
            { pattern: ['🚗', '🚙', '🚕', '🚗', '🚙', '🚕'], answer: '🚗', options: ['🚗', '🚙', '🚕', '🚌'] },
            { pattern: ['🌻', '🌷', '🌹', '🌻', '🌷', '🌹'], answer: '🌻', options: ['🌻', '🌷', '🌹', '🌺'] },
            { pattern: ['🍪', '🧁', '🍩', '🍰', '🍪', '🧁', '🍩'], answer: '🍰', options: ['🍪', '🧁', '🍩', '🍰'] }
